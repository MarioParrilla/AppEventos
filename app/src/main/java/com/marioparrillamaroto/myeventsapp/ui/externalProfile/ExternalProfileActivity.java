...
public class ExternalProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        datos.add(new Evento("Prueba5", LocalDateTime.now(),LocalDateTime.now().plusHours(1),"admin5","Pruebas5", true,true,0,0,0,"Preuba"));
        datos.add(new Evento("Prueba6", LocalDateTime.now(),LocalDateTime.now().plusHours(1),"admin6","Pruebas6", false,true,0,0,0,"Preuba"));
